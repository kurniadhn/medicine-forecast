    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-title">Logged in as : {{ Auth()->user()->is_admin === 1 ? 'Root' : 'Admin' }}
                </div>
                <a href="/profile" class="dropdown-item has-icon">
                    <i class="far fa-user"></i> Profile
                </a>
                <a href="/password" class="dropdown-item has-icon">
                    <i class="fas fa-cog"></i> Settings
                </a>
                <div class="dropdown-divider"></div>
                <form id="form" action="/logout" method="post">@csrf</form>
                <a href="javascript:void(0)" class="dropdown-item has-icon text-danger"
                    onclick="if(confirm('Are you sure?')){return document.getElementById('form').submit()}">
